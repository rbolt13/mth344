...
$\underline{\text{Fact}}$: Every row and column of G's operation tble contains each element of G exactly once. 
...
3. $\emptyset=\{\}$ is called a trivial subgroup of $\mathbb{Z}$. 
