...
Since $H\subseteq S_{\mathbb{Z}}$ contains the idenety, is closed under $\circ$, and closed under inverses, $H\leq S_{\mathbb{Z}}$. 
...
We call two cycles $\underline{\text{disjoin}}$ if they have no numbers in common. 
...
$\underline{\text{Fact}}$: Cycles that aren't dijoint don't necessary commute. 
