...
If the operation in $G_1$ and / or $G_2$ is "+", the above equation might look like $f(a+b)=f(a)f(b)$, $f(ab)=f(a)+f(b)$, or $f(a+b)=f(a)+f(b)$. 

If f is an isomorphism from $G_1$ to $G_2$, we call $G_1$ and $G_2$ $\underline{\text{isomporphic}}$ and we write $G_1\cong G_2$. 
...
Last, take any $a,b\in\mathbb{R}$. Then $$f(a+b)=10^{1+b}=10^a10^b=f(a)f(b)$$. 
...
Since $i^2=-1$, $i^3=-i$, and $i^4=1$, $G_2=\langle i\rangle$. 
...
$\Rightarrow e_2=f(e_2)$, by left cancellation. 
