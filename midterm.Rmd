...
$\underline{\text{Fact}}$: $S_A$ is nonabelian whenever $|A|\geq 3$. 
...
$\underline{\text{Note}}$: The group $S_4$ contains all permutations of $\{1,2,3,4\}$. So, $|S_4|=4\cdot 3\cdot 2\cdot 1=24$. Not all 24 of these elemetns in $S_4$ correspon to a symmetry of a square. For example, $f=(\begin{smallmatrix} 1 & 2 & 3& 4\\ 2 & 1 & 3 & 4\end{smallmatrix})$ doesn't represent a symmetry of a square. The group $D_4$ has only 8 elements. 
