...
One reason : $2,4\in H$ , but $2+4=1\in H$ (we'ew using the operation from $\mathbb{Z}$)'s). 
...
You can show that $\langle 4\rangle=\langle 2\rangle$ and $\langle 5\rangle=\mathbb{Z}_6$. We will see more about subgroups of $\mathbb{Z}_n$ in Ch. 11. 
...
Let G be a group.  subset $H\subseteq G$ is a $\underline{\text{subgroup}}$ of G if: 
