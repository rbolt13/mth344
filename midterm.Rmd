...
A cycle in $S_n$ is a permutation of the form $f=(a_1,a_2,a_3,...a_k)$ when $f(a_i)=a_{i+1}\forall 1\leq i\leq k-1$ and $f(a_k)=a_1$. 
...
For example can't write a permutation as a compostion of 3 transposition and also as a composition of 4 transpositions. 
