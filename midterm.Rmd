...
### Ex. Show $G\cong \langle \mathbb{Z},+\rangle$
...
$\underline{\text{Fact}}$: (We'll prove this in ch. 11): Every group of size 4 is isomorphic to $\mathbb{Z}_4$ or $\mathbb{Z}_2\times\mathbb{Z}_2$. 
